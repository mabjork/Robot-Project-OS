...
MainProgram: MainProgram.o SensorController.o EngineController.o PositionController.o BluetoothController.o
		...
		$(CC) MainProgram.o EngineController.o SensorController.o PositionController.o BluetoothController.o -Wall -w -lm -lev3dev-c -lm -lbluetooth -lpthread -o MainProgram
