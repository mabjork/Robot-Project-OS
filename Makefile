...
MainProgram: MainProgram.o SensorController.o EngineController.o PositionController.o BluetoothController.o ArmController.o
		...
		$(CC) MainProgram.o EngineController.o SensorController.o PositionController.o BluetoothController.o ArmController.o -Wall -w -lm -lev3dev-c -lm -lbluetooth -o MainProgram
...
local: 
		...
		$(CCL) MainProgram.o EngineController.o SensorController.o PositionController.o ArmController.o -Wall -w -lm -lev3dev-c -lm  -o MainProgram
